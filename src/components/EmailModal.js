        ...
        return (
            ...
            >
                ...
                <div>
                    ...
                    >
                        <input className='text-input' type='email' id='email' placeholder='you@example.com' autoComplete='true' required />
                        <input className='text-input' type='password' id='password' placeholder='Password' minLength='6' autoComplete='true' required />
